...
# run by bridge-box-online-tasks.sh (or the manual `bridge sync-players`), which
# ensures the client link is online first. It ASSUMES the box is already online
# — it does NOT touch the radio or any lock.
#
